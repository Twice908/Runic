  ...
  return (
    <div className="max-w-7xl mx-auto p-8 space-y-6">
      ...
      <div className="rounded-xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-6 shadow-sm">
        <div className="flex items-start justify-between gap-4">
          <div className="space-y-2 flex-1">
            <div className="h-3 w-12 animate-runic rounded bg-gray-200 dark:bg-slate-700" />
            <div className="h-6 w-80 animate-runic rounded bg-gray-200 dark:bg-slate-700" />
          </div>
          <div className="h-6 w-24 animate-runic rounded-full bg-gray-200 dark:bg-slate-700" />
        </div>
        <div className="mt-6 grid grid-cols-4 gap-4">
          {[0, 1, 2, 3].map((i) => (
            <div key={i} className="space-y-2">
              <div className="h-3 w-16 animate-runic rounded bg-gray-200 dark:bg-slate-700" />
              <div className="h-4 w-20 animate-runic rounded bg-gray-200 dark:bg-slate-700" />
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="space-y-3">
        <div className="h-5 w-24 animate-runic rounded bg-gray-200 dark:bg-slate-700" />
        <div className="rounded-xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-sm overflow-hidden">
          ...
          {[0, 1, 2, 3, 4, 5].map((i) => (
            ...
            >
              ...
              <div className="h-4 w-40 animate-runic rounded bg-gray-200 dark:bg-slate-700" />
              <div className="h-4 w-20 animate-runic rounded bg-gray-200 dark:bg-slate-700" />
